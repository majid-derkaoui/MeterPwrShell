...
echo -e $okegreen [---] The Output File Is On The : output/meterpwrshelloutput$payarch.txt [---]
echo -e $okegreen [---] The Handler File Is On The : output/meterpwrshellhandler$payarch.rc [---]
figlet "...GoodBye..."
